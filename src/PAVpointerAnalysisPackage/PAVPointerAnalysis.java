...
import PAVpointerAnalysisPackage.approachA.Graph;
...
public class PAVPointerAnalysis {
	...
	public PAVPointerAnalysis(String classpath, String mainClass,
			String analysisClass, String analysisMethod) {
		setup = new SetUpAnalysis(classpath, mainClass, analysisClass,
				analysisMethod);
	}
	...
	public void runAnalysis() throws Exception {
		...
		AlgorithmA.performIPACallString(setup);
		Graph.printMethods();
	...
	public static void main(String[] args) throws Exception {
		...
		PAVPointerAnalysis pAnalysis = new PAVPointerAnalysis(classpath,
				mainClass, analysisClass, analysisMethod);
